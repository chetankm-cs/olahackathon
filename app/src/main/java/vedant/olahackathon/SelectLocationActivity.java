...
//        = servicesSingleton.getUserLocation();
//        if (userLocation != null)
//            startLatLng = new LatLng(userLocation.getLatitude(), userLocation.getLongitude());
//        else
            startLatLng = BANGALORE_LOCATION;
        mLastCameraPosition = new CameraPosition.Builder().target(startLatLng).zoom(14).build();
...
//        LatLng latLng = mSelectedLocationMarker.getPosition();
        ...
        finish();
        Log.d("tag", "address updated by MapActivity:" + mLastFetchedAddress);
    }
...
//            mSelectedLocationMarker.setSnippet(address.getAddressLine(0));
            mLastFetchedAddress = readableAddress(address);
...
//        mSelectedLocationMarker.showInfoWindow();
    ...
    public void onResume() {
        ...
        // 40 dp in pixels
        int px40 = dpToPixels(40);
        // 8 dp in pixels
        int px8 = dpToPixels(8);
